var page = {
	...
	init:function(arg)
	{
		var val = arg.data.param;
		
		var obj={
			"rsrv_mgr_no" : String(val.rsrv_mgr_no),
			"inv_no" : String(val.inv_no),
			"cldl_sct_cd" : val.cldl_sct_cd
		};
	...
	, invDtlCallback : function(data){
		try{
			...
			if (data.data_count !== 0 && smutil.apiResValidChk(data)&& data.code==="0000") {
				...
				var template = Handlebars.compile($("#CLDL0202_list_template").html());
