...
//				}
			...
			$(document).on('click', '.btn.cancel', function(e){
				...
				// 스켄 취소 전문 호출
				_this.plnScanCcl(inv_no, cldl_sct_cd);
			...
			Handlebars.registerHelper('cldlSctCdChkTag', function(options) {
				...
				if(this.cldl_sct_cd === "P"){	// 집하
					if(!smutil.isEmpty(this.snper_nm)){
						html = html + '<li class="list1">' + this.snper_nm + '</li>';
					}
					...
					if(!smutil.isEmpty(phoneNumber)){
						html = html + '<li class="list2">' + phoneNumber + '</li>';
					}
				
				}
				else{	// 배달
					if(!smutil.isEmpty(this.acper_nm)){
						html = html + '<li class="list1">' + this.acper_nm + '</li>';
					}
				...
				if(!smutil.isEmpty(this.req_acpr_nm)){
					if(this.req_acpt_rgst_sct_cd == "01"){		// 고객요청
						html = html + '<li class="list3" id="reqAcptSctCd_'+this.inv_no+'" data-req-acpt-sct-cd='+this.req_acpt_sct_cd+'><span class="tGreen">' + this.req_acpr_nm + '</span></li>';
					}
					else if(this.req_acpt_rgst_sct_cd == "02"){		// 기사변경
						html = html + '<li class="list3" id="reqAcptSctCd_'+this.inv_no+'" data-req-acpt-sct-cd='+this.req_acpt_sct_cd+'><span class="tRed">' + this.req_acpr_nm + '</span></li>';
					}
				}
